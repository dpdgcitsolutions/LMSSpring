...
<div class="users">
	<div class="container">
		<a style="font-size:20px;" href="/">Back</a><br/>
...
<table class="table table-hover">
	...
	<%for(LibraryBranch l: libs){ %>
		<tr>
			...
			<td><button type="button" class="btn btn-success" onclick="javascript:location.href='librarian/selectBranch?branchId=<%=l.getBranchId()%>'">SELECT</button></td>
			<td><button type="button" class="btn btn-warning" data-toggle="modal" 
			data-target="#editBranchModal" href='librarian/prepareEditBranch?branchId=<%=l.getBranchId() %>'>EDIT</button></td>
